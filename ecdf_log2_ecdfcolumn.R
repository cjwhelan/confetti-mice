...
#D:\confetti_mice
#make an object
ECDF_volume<-read.csv( "D:\\confetti_mice\\ecdf data\\ECDF_volume.csv")
...
write.csv(trunc_volumes, file = "D:/confetti_mice/trunk_volumes.csv")
...
trunc_ecdf_volume <- trunc_log2_volume
trunc_ecdf_volume <- ecdf(trunc_log2_volume$structure_volume)
trunc_ecdf_volume
...
fun.ecdf<-ecdf(trunc_log2_volume$structure_volume) #make a function that applies ecdf to your data

my.ecdf<-fun.ecdf(sort(trunc_log2_volume$structure_volume)) # apply that function to a sorted list of your data to give the cumulative probabilities 

trunc_log2_volume$distribution_volume<-my.ecdf #add the cumulative probabilities to your data frame
