...
#make an object
ECDF_volume<-read.csv( "D:\\confetti_mice\\allmice_volumes\\allmice_vols_corrected.csv")
...
write.csv(trunc_volumes, file = "D:/confetti_mice/trunc_vols_corrected.csv")
...
ECDF_log2_truncvolume_plot <- ggplot(trunc_volumes, aes(x = (ln2volume), color = treatment)) +
...
mice_allmonths_plot <- ggplot(mice_allmonths, aes(x = (ln2volume), color = treatment)) +
  labs(colour = "Treatment") +
  scale_colour_discrete(labels = c("No UV", "UV")) +
  theme(legend.title=element_text(size=14), 
        legend.text=element_text(size=14)) +
...
mice_allmonths_plot <- ggplot(mice_allmonths, 
                              aes(x = (ln2volume), 
                              color = treatment)) +
  labs(colour = "Treatment") +
  scale_colour_discrete(labels = c("No UV", "UV")) +
...
m1_mice_allmonths_plot <- ggplot(m1_mice_allmonths, aes(x = (ln2volume), color = treatment)) +
  labs(colour = "Treatment") +
  scale_colour_discrete(labels = c("No UV", "UV")) +
  theme(legend.title=element_text(size=14), 
        legend.text=element_text(size=14)) +
...
m1_mice_allmonths_plot2 <- ggplot(m1_mice_allmonths, aes(x = (ln2volume), color = treatment)) +
  labs(colour = "Treatment") +
  scale_colour_discrete(labels = c("No UV", "UV")) +
  theme(legend.title=element_text(size=14), 
        legend.text=element_text(size=14)) +
